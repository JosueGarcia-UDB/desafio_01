...
const ListaHorarios = ({ horarios }) => {
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-primary-emphasis text-center p-3">
      ...
      <div className="d-flex gap-4">
        <button
          className={`flex-grow-1 btn ${
            consultorioSeleccionado === "consultorio1"
              ? "btn-primary fw-bold"
        ...
        <button
          className={`flex-grow-1 btn ${
            consultorioSeleccionado === "consultorio2"
              ? "btn-primary fw-bold"
              : "btn-light border-secondary"
          }`}
          ...
          <div key={index} className="col-6 col-md-4 col-lg-3 mb-2">
            <div
              className={`p-3 border rounded text-center fw-bold ${
                horario[consultorioSeleccionado] === "Ocupado"
      ...
      <div className="mt-4 p-3 bg-light rounded mb-5">
        ...
        <ul className="mb-0">
          <li>
            Los horarios en <span className="text-success fw-bold">verde</span>{" "}
            están disponibles para reservar.
          </li>
          <li>
            Los horarios en <span className="text-danger fw-bold">rojo</span> ya
            están ocupados.
          </li>
